...
button.addEventListener("click", () => {
  if (
    ...
    document.querySelector(".users__base").classList.add("hidden");
    document.querySelector(".to__do").classList.add("visible");
  } else {
...
btnRegistration.addEventListener("click", () => {
  if (userOpenLogin.value !== "" && userOpenPassword.value !== "") {
    document.querySelector(".registration").classList.add("hidden");
    document.querySelector(".password").classList.add("visible");
    document.querySelector(".users__base").classList.remove("hidden");
  } else {
...
btnBack.addEventListener("click", () => {
  document.querySelector(".registration").classList.add("visible");
  document.querySelector(".password").classList.add("hidden");
  document.querySelector(".users__base").classList.add("hidden");
});
...
btnUsers.addEventListener("click", () => {
  if (
    ...
    document.querySelector(".registration").classList.add("hidden");
    document.querySelector(".password").classList.add("hidden");
    document.querySelector(".users__base").classList.add("visible");
...
//скрытие списка
  document.querySelector("#users__base__list").classList.add("hidden");
  document.querySelector("#users__base__table").classList.add("visible");
